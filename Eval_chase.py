...
from UNet import ODE_UNet
model = MSFF_Net(input_size=(desired_size, desired_size, 3), start_neurons=16, lr=1e-4, keep_prob=1, block_size=1)
model.summary()
...
for y in y_pred:
    ...
    y = y * 255
    cv2.imwrite('./results/CHASE/%d.png' % i, y)
    i+=1
